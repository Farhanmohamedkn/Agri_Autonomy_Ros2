...
- Coverage mission planning (lawnmower patterns)
- Simulation-first development using Gazebo
- Upgrade path to RTK GNSS and multi-sensor fusion
...
- PX4 / ArduPilot (SITL)
- GNSS (GPS, RTK-ready)
- Sensor fusion (IMU, LiDAR, Camera – future work)

## Status
🚧 Early development (simulation + GPS baseline)
